...
void drawButton(Button* button, SceneType currentScene) {
    ...
    //     if (button->isPressed) {
    //         GFX_DrawImageAt(button->imagePressed, button->x, button->y, 0.0f, NULL, button->sizenmachen, button->sizenmachen);
    //     } else {
    //         GFX_DrawImageAt(button->imageNormal, button->x, button->y, 0.0f, NULL, button->sizenmachen, button->sizenmachen);
    //     }
    // }
}
